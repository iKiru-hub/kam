...
one-shot reconstruction of shuffled MEC+LEC patterns under both an
instructive-driven rule (mean output--target cosine, 0.880 aligned versus 0.247
permuted) and a bounded error-driven rule (0.872 versus 0.178). Applying the corresponding permutation
...
continuous mixtures of spatially stable and cue-modulated responses, while
differing quantitatively in tuning stability and position decodability. During
frozen recall, selective degradation of lateral or medial
...
dense common-key control failed to distinguish cue or position states.
Separate covariance-matrix-adaptation searches identified distinct operating
regimes for the two plasticity rules. Local parameter perturbations and a
held-out load test with up to 90 ordered cue pairs exposed rule-dependent
sensitivity and interference beyond the shared reference setting. These
