...
seed. The Results report the 0.90 partial-degradation point; the curves continue
to complete ablation for reference.
...
\end{equation}
The degraded condition independently removed 50\% of LEC units with four masks
per stored pair; mask-level exact scores were averaged within pair and then
